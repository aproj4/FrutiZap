 ...
 * Representa el tablero del juego de memoria.
 * Contiene todas las tarjetas, las mezcla aleatoriamente
 * y valida parejas seleccionadas.
 */
public class Tablero {
     ...
     * Retorna la tarjeta en la posición indicada.
     *
     * @param indice posición de la tarjeta (0 basado)
     * @return tarjeta en la posición indicada
     */
    ...
    /**
     * Verifica si un índice de tarjeta puede seleccionarse.
     * @param indice posición de la tarjeta
     * @return true si la selección es válida y la tarjeta no está encontrada
     */
    public boolean esSeleccionValida(int indice) {
        return indice >= 0 && indice < getTotalTarjetas() && !tarjetas.get(indice).isFueEncontrada();
    }
