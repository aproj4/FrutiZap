...
/**
 * Pruebas unitarias para la clase Tarjeta.
 * Verifica el comportamiento del volteo, el contador de volteos
 * y la marca de tarjetas encontradas.
 */
public class TarjetaTest {
    ...
    /**
     * Configura el estado inicial de la prueba creando una tarjeta nueva.
     */
    @BeforeEach
    public void setUp() {
        tarjeta = new Tarjeta("🍎");
